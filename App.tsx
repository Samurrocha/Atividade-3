  ...
  return (
    <ScrollView ref={scrollRef}>
      <View style={styles.container}>
        ...
        <Text style={styles.InputText}>pesquise um lugar aqui!!</Text>
          <TextInput
            style={styles.input}
            placeholder='alohaa'
            value={SearchPlace}
        ...
        <View ref={quebec} style={styles.place}>
          ...
          <Text style={styles.textDescription}>
            ...
            Quebec também é famosa pela sua vibrante cena cultural, com museus, galerias de arte e teatros. O placenaval de Quebec, realizado anualmente no inverno, é um dos maiores e mais famosos do mundo, oferecendo desfiles, festas e diversas atividades ao ar livre, como corrida de trenó e esculturas de gelo.
            Além de sua história e cultura, a cidade também é conhecida por sua culinária, com pratos tradicionais como poutine, torta de placene e maple syrup (xarope de bordo), que são destaque em muitos restaurantes locais.
        ...
        <View ref={rioDeJaneiro} style={styles.place}>
          ...
          <Text style={styles.textDescription}>
            ...
            O Pão de Açúplace, com seu bondinho e vistas espetaculares, é outro ponto turístico imperdível, oferecendo uma das vistas mais bonitas do mundo.
            A cidade também é conhecida pelo placenaval, uma celebração de música, dança e cores, atraindo milhares de turistas de todo o mundo.
